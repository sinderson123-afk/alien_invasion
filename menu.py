...
class MenuSystem:
    ...
    def _create_menu_buttons(self):
        ...
        self.btn_start = Button(
            ...
            border_radius=12)
        self.btn_start.rect.center = (cx, start_y)
        ...
        self.btn_shop = Button(
            ...
            font_size=self.settings.menu_button_font_size,
            border_radius=12)
        self.btn_shop.rect.center = (cx, start_y + gap)
        ...
        self.btn_tutorial = Button(
            ...
            font_size=self.settings.menu_button_font_size,
            border_radius=12)
        self.btn_tutorial.rect.center = (cx, start_y + gap * 2)
    ...
    def _create_pause_buttons(self):
        ...
        self.btn_resume.rect.center = (cx, cy - gap)
        ...
        self.btn_quit_to_menu = Button(
            ...
            font_size=40, border_radius=10)
        self.btn_quit_to_menu.rect.center = (cx, cy)
        ...
        self.btn_exit = Button(
            ...
            font_size=40, border_radius=10)
        self.btn_exit.rect.center = (cx, cy + gap)
    ...
    def draw_start_screen(self, mouse_pos=None):
        """Draw the start screen: title + three buttons"""
        cx = self.screen_rect.centerx
        ...
        title_rect.bottom = self.btn_start.rect.top - 40
    ...
    def draw_pause_overlay(self, mouse_pos=None):
